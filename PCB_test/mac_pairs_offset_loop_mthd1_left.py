...
starting_mac = 5
num_of_macs = 12                                          # please specify how mant MACs you have the data for
...
if __name__ == "__main__":
    ...
    try:
        ...
        for i in range (starting_mac,(starting_mac+num_of_macs)):
            ...
            i2c_path = os.getcwd()
            i2c_path = os.path.join(i2c_path,'i2c_files')
            i2c_path = os.path.join(i2c_path,'offset_pairs_mthd1_left')        #specify what kind of test you are running
            ...
            dir3 = os.path.join(i2c_path,'MacL_Down')               # offset test name                         
