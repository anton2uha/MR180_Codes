...
i2c_path = os.path.join(i2c_path,'mac16_offset')          # This is the Test Directory Name - Please Specify for each individual test
num_files = 10                                       # Please Specify How many i2c files are in that directory
    ...
    try:
        ...
        for n in range(0,num_files):        ############for testing########
            ...
            if n == 0:
                ...
                rst_amon()
                first_DMON_toggle = True
                first_DMON = D_state
                print('...................................................')
            elif first_DMON_toggle and D_state != first_DMON:
                # mon_dac5_macL_actP()
                # actp  = chp_adc.read_amon()
                # mon_dac4_macL_actN()
                # actn  = chp_adc.read_amon()
