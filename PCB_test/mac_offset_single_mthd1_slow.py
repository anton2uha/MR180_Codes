...
num_of_files_each_test = 957                            # Please Specify How many i2c files are in each test
...
if __name__ == "__main__":
    ...
    try:
        ...
        for i in range (starting_mac,(starting_mac+num_of_macs)):
            ...
            i2c_path = os.getcwd()
            i2c_path = os.path.join(i2c_path,'i2c_files')
            i2c_path = os.path.join(i2c_path,'offset_mthd1_single')        #specify what kind of test you are running
            ...
            directories = [dir4]                            ############# DANGER ################## DANGER ################ DANGER ############## DANGER ##########
