...
starting_mac = 1
num_of_macs = 16                                          # please specify how mant MACs you have the data for
num_of_files_each_test = 273                            # Please Specify How many i2c files are in each test
...
if __name__ == "__main__":
    ...
    try:
        ...
        for i in range (starting_mac,(starting_mac+num_of_macs)):
            ...
            i2c_path = os.getcwd()
            i2c_path = os.path.join(i2c_path,'i2c_files')
            i2c_path = os.path.join(i2c_path,'offset_pairs_mthd1')        #specify what kind of test you are running
            i2c_path = os.path.join(i2c_path,str(i))


            dir1 = os.path.join(i2c_path,'MacR_UpL')               # offset test name
            dir2 = os.path.join(i2c_path,'MacR_UpR')               # offset test name
            dir3 = os.path.join(i2c_path,'MacR_Down')               # offset test name                         
