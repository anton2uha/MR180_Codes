...
num_of_files_each_test = 8                            # Please Specify How many i2c files are in each test
...
if __name__ == "__main__":
    ...
    chp_idle_i2 = chp_pwr.iin()
    chp_idle_vsh2 = chp_pwr.vshunt()
    i_sum = chp_idle_i2 + i_sum
    vsh_sum = chp_idle_vsh2 + vsh_sum
    ...
    try:
        ...
        for i in range (starting_mac,(starting_mac+num_of_macs)):
            ...
            i2c_path = os.getcwd()
            i2c_path = os.path.join(i2c_path,'i2c_files')
            i2c_path = os.path.join(i2c_path,'offset_mac_power')        #specify what kind of test you are running
            ...
            directories = [dir1]                       # making a list of those names
