...
if __name__ == "__main__":
    ...
    try:
        ...
        for i in range (starting_mac,(starting_mac+num_of_macs)):
            ...
            i2c_path = os.getcwd()
            i2c_path = os.path.join(i2c_path,'i2c_files')
            i2c_path = os.path.join(i2c_path,'lin_mthd2')        #specify what kind of test you are running
            i2c_path = os.path.join(i2c_path,str(i))


            dir1 = os.path.join(i2c_path,'Mac_UpL')               # offset test name
            dir2 = os.path.join(i2c_path,'Mac_UpR')               # offset test name
                       
            # directories = [dir1,dir2]                       # making a list of those names
            directories = [dir1]
