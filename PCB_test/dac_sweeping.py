...
i2c_path = os.path.join(i2c_path,'dac_sweeping')          # This is the Test Directory Name - Please Specify for each individual test
num_files = 113                                        # Please Specify How many i2c files are in that directory
clock_speed = 1e6                                       # Please specify your MACs clock rate
...
def chp_pcb_config():
    ...
    GPIO.setup(dmon_lcas, GPIO.IN, pull_up_down=GPIO.PUD_UP)
...
if __name__ == "__main__":
    ...
    try:
        ...
        for n in range(0,num_files):        ############for testing########
            ...
            send_i2c_file_2pi(rst,sda,scl)
            print("..........Data Was Sent.........")
            wghtn  = chp_adc.read_amon()
            #print ("MAC-Left Activation Positive:%fmV"%(macl_act_pos['r']))
#            save_result(i2c_path,'results.csv','iteration',n,'MACL_ACT_POS',macl_act_pos['r'],'chp_current(A)',i_chip,'chp_supply(mV)',chp_vdd['r'],'chp_vss(mV)',chp_vss['r'],'DMON_State',D_state)
            save_result(i2c_path,'results.csv','iteration',n,'chp_current(A)',i_chip,'DAC',wghtn)
            print('...................................................')
