...
k = 0               # variable used for keeping track of saved results 
    ...
    try:
        ...
        #     directories = [dir1]
            ...
            for z, directory in enumerate(directories):
                ...
                for n in range(0,num_of_files_each_test):        
                    rst = []                        
                    sda = []
                    scl = []
                    fname = f"{n}"                  
                    ...
                    print(D_state)
                    if n==0:
                          last_value = avg_noise['r']


                    elif  (n<10) or (n>num_of_files_each_test-10):
                        last_value = avg_noise['r']
