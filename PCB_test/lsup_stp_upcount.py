...
class Main:
    ...
    def lcas_supp_stp_up_count(self):
        if self.lcas_supp:
            ...
            if stp<1:
                ...
                if stp==1:
                    self.lcas_supp.switch_dis(1)
                elif stp==2:
                    self.lcas_supp.switch_dis(1)
                    self.lcas_supp.switch_dis(2)
                elif stp==3:
                    self.lcas_supp.switch_dis(1)
                    self.lcas_supp.switch_dis(2)
                    self.lcas_supp.switch_dis(3)
                elif stp==4:
                    self.lcas_supp.switch_dis(1)
                    self.lcas_supp.switch_dis(2)
                    self.lcas_supp.switch_dis(3)
                    self.lcas_supp.switch_dis(4)
                    ...
                    self.lcas_supp.switch_dis(3)
                    self.lcas_supp.switch_dis(4)
                    self.lcas_supp.count_up_stp(stp-4)
                else:
...
if __name__ == "__main__":
    try:
        main_run = Main()
        main_run.pcb_init()
        main_run.lcas_supp_stp_up_count()
